...
def load_bmp_convert_to_nifti_borders(
    ...
    if lab_file is not None:
        l = imread(lab_file)
        borders = generate_border_as_suggested_by_twollmann(
...
def generate_border_as_suggested_by_twollmann(
...
def prepare_task(
    ...
    for train_sequence in [
        ...
        for t in train_cases:
            ...
            res.append(
                p.starmap_async(
                    load_bmp_convert_to_nifti_borders,
                    (
                        (
                            img_file,
                            lab_file,
...
def convert_to_instance_seg2(
    arr: np.ndarray,
    spacing: tuple = (0.2, 0.125, 0.125),
